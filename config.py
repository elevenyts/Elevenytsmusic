...
class Config:
    def __init__(self):
        ...
        # Support Links
        self.SUPPORT_CHANNEL: str = getenv("SUPPORT_CHANNEL", "https://t.me/Endless_Affection_n")
        self.SUPPORT_CHAT: str = getenv("SUPPORT_CHAT", "https://t.me/Tks_Gc")
        ...
        self.ARTISTBOTS_KEY: str = getenv("ARTISTBOTS_KEY", "ShrutiBotstSAVJNt95bC66c7TJh2t")
        ...
        self.STICKER_ID: str = getenv("STICKER_ID", "https://t.me/addstickers/Hii6960")
